...
def load_data():
    ...
    region_kpi = pd.read_csv(r"C:\Users\User\Desktop\GitHubFiles\Factory to Customer Shipping Route Analysis\Data\Region_KPI_table.csv")
    state_kpi = pd.read_csv(r"C:\Users\User\Desktop\GitHubFiles\Factory to Customer Shipping Route Analysis\Data\State_KPI_table.csv")
    state_mapping = pd.read_csv(r"C:\Users\User\Desktop\GitHubFiles\Factory to Customer Shipping Route Analysis\Data\State_Mapping.csv")
    state_mapping_with_coords = pd.read_csv(r"C:\Users\User\Desktop\GitHubFiles\Factory to Customer Shipping Route Analysis\Data\State_Mapping_with_Coords.csv")
