...
@st.cache_data
def load_data():
    df = pd.read_csv(r"C:\Users\User\Desktop\GitHubFiles\Factory-to-customer-shipping-route-efficiency-analysis\Data\Nassau Candy Distributor.csv")
    region_kpi = pd.read_csv(r"C:\Users\User\Desktop\GitHubFiles\Factory-to-customer-shipping-route-efficiency-analysis\Data\Region_KPI_table.csv")
    state_kpi = pd.read_csv(r"C:\Users\User\Desktop\GitHubFiles\Factory-to-customer-shipping-route-efficiency-analysis\Data\State_KPI_table.csv")
    state_mapping = pd.read_csv(r"C:\Users\User\Desktop\GitHubFiles\Factory-to-customer-shipping-route-efficiency-analysis\Data\State_Mapping.csv")
    state_mapping_with_coords = pd.read_csv(r"C:\Users\User\Desktop\GitHubFiles\Factory-to-customer-shipping-route-efficiency-analysis\Data\State_Mapping_with_Coords.csv")
